    ...
    <div id="Projects" className="projects">
      <div className="project-container">
        ...
        <ProjectContainer
          ...
          TechText={
            "Tech includes: React.js, Firebase, Google Maps API, Cheerio, Axiom, RESTful Routes, Google Cloud Functions, CSS"
          }
        />
        <ProjectContainer
        ...
        <ProjectContainer
          ...
          TechText={
            "Tech Includes: JavaScript, MongoDB, Express, React.js, Node.js, Flexbox"
          }
        />
      </div>
    </div>
